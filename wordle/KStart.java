...
// key += Math.pow(3, this.l * j) *
// this.compare.get(l.get(j)).get(this.ans.get(i));
...
// throw new IllegalArgumentException("Too many arguments, require <= this.k
// arguments");
// }
...
// Pair<Tree<String, Long>, Integer> p = starts.stream().map(x ->
// this.miniSolveMemo(x, w)).parallel()
